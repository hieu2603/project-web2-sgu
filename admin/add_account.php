...
if (isset($_POST['add_account_btn'])) {
  ...
  if ($stmt->execute()) {
    ...
    header('location: add_account.php?error=Lỗi khi tạo mới người dùng');
  }
}
            ...
            <div class="container-fluid">
              <div class="row mb-2">
                <div class="form-group col-md-6 mt-2">
                  <label class="form-label" for="account-name">Tên người dùng</label>
              ...
              <div class="row mb-2">
                <div class="form-group col-md-6 mt-2">
                  <label class="form-label" for="account-password">Mật khẩu</label>
                  <input type="password" name="account_password" class="form-control" id="account-password">
                </div>
                <div class="form-group col-md-6 mt-2">
